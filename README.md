...
|------| -------------------------------------------------------|-------------------------------------------| -----------------|
|GET   | http://courseapi.abbsnabb.com/posts/:groupName            | Lists all posts                           | application/json |
|POST  | http://courseapi.abbsnabb.com/posts/:groupName            | Creates a post.                           | application/json |
|GET   | http://courseapi.abbsnabb.com/posts/:groupName/:postId    | Fetches the post with the given postId    | application/json |
|PUT   | http://courseapi.abbsnabb.com/posts/:groupName/:postId    | Updates the post with the given postId    | application/json |
|DELETE| http://courseapi.abbsnabb.com/posts/:groupName/:postId    | Deletes the post with the given postId    | application/json |
